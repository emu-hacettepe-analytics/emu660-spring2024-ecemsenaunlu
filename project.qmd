...
Additionally, we will use a second data set to examine the relationship between education levels and crime rates. This data set provides us with crimes and crime rates according to education levels in 2020. In addition, I think that the population numbers of the provinces in 2020 are an important data source to evaluate the relevant data correctly.
...
xxxxxx
# MasterTotal için çubuk grafik oluşturma
plot2 <- result %>%
  ggplot() +
  geom_bar(aes(x = ProvinceName, y = MasterTotal, fill = "Master Total"), 
           stat = "identity", position = "dodge") +
  labs(title = "Distribution of Master Total by Province in 2020",
       x = "Province",
       y = "Total Count",
...
# İki grafiği üst üste yerleştirme
