...
```
The variance of the error terms turned out to be 0.009, and since the p value is less than 0.05, it can be interpreted that it does not have a constant variance. It took the value of p = 0.0707 and is not significant. The F-statistic is 3.362 and the p-value is 0.07069. This is used to evaluate whether the model is statistically significant in explaining the dependent variable. Since the p-value here is greater than 0.05, it cannot be said that the model is statistically significant. The R-squared value of the model is 0.0429. A low R-squared value indicates that the model does not have sufficient power to explain it.
