...
Below you can find the names of all columns in the education data set and information about the data they represent.
...
We will have a lot of summary data thanks to the data set that will allow us to analyze the education levels in Turkey. And we will observe the relationships between the data.
